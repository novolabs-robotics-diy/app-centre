...
function on_init()
    ...
    lv_obj_set_style_text_color(ui.songPlayTime, lv_color_hex(0x808080), LV.PART_MAIN)
    ...
    lv_obj_set_style_bg_color(ui.panel, lv_color_hex(0x101010), LV_PART_MAIN)
    lv_obj_set_style_border_color(ui.panel, lv_color_hex(0x202020), LV_PART_MAIN)
    lv_obj_clear_flag(ui.panel, LV_OBJ_FLAG_SCROLLABLE)
    lv_obj_set_flex_flow(ui.panel, LV_FLEX_FLOW_ROW)
    lv_obj_set_flex_align(ui.panel, LV_FLEX_ALIGN_SPACE_BETWEEN, LV_FLEX_ALIGN_START, LV_FLEX_ALIGN_CENTER)
